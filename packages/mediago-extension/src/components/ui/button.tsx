...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium font-feat-display [transition:color_var(--transition-color),background-color_var(--transition-color),box-shadow_var(--transition-shadow)] focus-visible:outline-none focus-visible:shadow-focus disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 [&_svg]:stroke-[1.75] cursor-pointer",
  {
    variants: {
      variant: {
        default:
