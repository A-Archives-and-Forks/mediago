 ...
 *
 * Usage:
 *   tsx packages/tooling/src/runtime-deps/download.ts
 *   tsx packages/tooling/src/runtime-deps/download.ts --all
 *   tsx packages/tooling/src/runtime-deps/download.ts --platform linux-x64
 *   tsx packages/tooling/src/runtime-deps/download.ts --tools aria2,N_m3u8DL-RE,ffmpeg
 */
...
import manifestJson from "../../manifests/runtime-deps.json" with { type: "json" };
import {
...
import { selectToolsFromArgs } from "./args.ts";
import {
